<template>
  <div class="m-header">
    ...
    <transition name="user">
      <user ref="user" v-if="showFlag" @ievent="parentListen" @child-say="listenToMyBoy" :showFlag="showFlag"></user>
    </transition> 
  </div>
  </div>
</template>
...
.m-header {
  ...
  .center {
    ...
    .icon {
      ...
      height: 44px;
      margin-right: 9px;
      background: url(../../common/image/cat.png) no-repeat;
